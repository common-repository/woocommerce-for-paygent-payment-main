...
namespace ArtisanWorkshop\WooCommerce\PluginFramework\v2_0_13;

use WP_Error;if ( ! defined( 'ABSPATH' ) ) {
    exit;
}

if (!class_exists('\\ArtisanWorkshop\\WooCommerce\\PluginFramework\\v2_0_13\\JP4WC_Plugin')):
    class JP4WC_Plugin {
        /**
         ...
         * @return array
         */
        public function jp4wc_option_setting($slug, $prefix = null, $array_name = null, $password = null){
         ...
         */
        public function jp4wc_input_checkbox($slug, $description, $prefix = null, $array_name = null){
            ?>
